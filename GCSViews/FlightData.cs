...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        class NaiveBayesProgram
        {
            ...
            public string t, b, h, result;

            public int x12;


            public NaiveBayesProgram(double tx, double by, double hz)
            {

                ///////////////////////////////////
                //////////////////////////////////////
                if (tx > 35) { t = "x"; }
                else if (tx < 35 && tx > 25) { t = "h"; }
                else if (tx < 25 && tx > 15) { t = "m"; }
                else if (tx < 15) { t = "l"; }


                if (by > 900) { b = "h"; }
                else if (by < 900 && by > 800) { b = "m"; }
                else if (by < 800) { b = "l"; }
            ...
            static string conversion_tmp(string s)
            {

                // "administrative", "construction", "education", "technology"
                string val = "";

                if (s == "x") { val = "administrative"; }
                else if (s == "h") { val = "construction"; }
                else if (s == "m") { val = "education"; }
                else { val = "technology"; }
            ...
            static string conversion_baro(string s)
            {
            ...
            static string conversion_baro_str(string s)
            {
            ...
            static string conversion_humo(string s)
            {
                string val = "";
            ...
            static string conversion_sex(string s)
            {
                string val = "";
            ...
            static void process(string a1, string b1, string c1)
            {
                ...
                try
                {
                    ...
                    numericAttributeBorders[0] = new double[] { 0.0, 3000.0 }; // height range: [57.0 to 78.0]
                    ...
                    string occupation = conversion_tmp(a1); //"education";
                    string dominance = conversion_humo(b1); // "right";
                    string height = conversion_baro_str(c1); //"tall";
            ...
            static string[] MakeData(int numRows) // make dummy data
            {
                ...
                string[,] weather_train = new string[40, 4]{{"l", "m","h","n"},
{"h", "l","l","y"},
{"m", "h","l","y"},
{"x", "m","h","y"},
{"l", "l","l","n"},
...
{"h", "h","l","y"}};
                ...
                for (int i = 0; i < numRows; ++i)
                {
                    ...
                    string sex = conversion_sex(weather_train[i, 3]);// MakeSex();
                    string occupation = conversion_tmp(weather_train[i, 0]);//MakeOccupation(sex);
                    string dominance = conversion_humo(weather_train[i, 2]);// MakeDominance(sex);
                    string height = conversion_baro(weather_train[i, 1]); // MakeHeight(sex);
        ...
        public List<string> lat1 = new List<string>();
        public List<string> lng1 = new List<string>();
...
/*
        ...
        */
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            string uri = "http://ahsatan.com/tanvir_space/eliv.php";
